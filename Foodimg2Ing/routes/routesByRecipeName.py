...
@recipeApi.route('/searchByRecipeName', methods=['GET', 'POST'])
def get_recipes():
    recipes = []
    nutrients_data = []
    ...
    if request.method == 'POST':
        ...
        # print('------------------------------------\n\n')
        return render_template('SearchByRecipeName/output_SearchByRecipe.html', recipes=recipes, nutrients_data=nutrients_data)        
    return render_template('SearchByRecipeName/searchByRecipeName.html')
